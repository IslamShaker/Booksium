  ...
  return (
    <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12">
      ...
      <div className="md:w-1/2 space-y-6">
        ...
        Now . . . . , The visiters rate shown here including the book lists and thee number of registered users and how many books have been downloaded from our website.
         If you are intersested in exploring more about oue store then click here . 
         </p>
